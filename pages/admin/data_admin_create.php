  ...
  <section class="forms">
    <div class="container-fluid">
          ...
          <header>
            ...
            <h1 class="h3 display">Data Admin</h1>
          </header>
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
...
//mendefinisikan id admin apakah dari tombol edit atau bukan
  ...
  if(isset($_GET['id'])){
    //$id=id dari tombol edit
    $id=$_GET['id'];
    ?> <form class="form-horizontal" action="data_admin_update.php" method="post">  <?php
  }
  else{
      //jika tidak, maka $id=$kodeAdmin;
      $id=$kodeAdmin;
    ?>  <form class="form-horizontal" action="data_admin_simpan.php" method="post"> <?php
  }
?>
